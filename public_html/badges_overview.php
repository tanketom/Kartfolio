...
// The catalogue (private/includes/badge_catalog.php) is the one place badges
// are defined; this page used to carry its own copy of all 91.
$allBadgeDefinitions = badgeCatalogByCategory();
