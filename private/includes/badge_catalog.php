...
function badgeCatalog(): array {
    ...
    return $c = [
        ...
        'mikko_clean_sweep' => ['icon' => '🧨', 'title' => 'Clean Sweep', 'desc' => 'Won every Mikkoliiga GP you contested.', 'criteria' => 'Won every Mikkoliiga GP contested in a season (3 or more)', 'category' => 'honours'],
        'mikko_cold_start' => ['icon' => '🧊', 'title' => 'Cold Start', 'desc' => 'Won the very first Mikkoliiga GP you ever raced.', 'criteria' => 'Took first among members in your Mikkoliiga debut', 'category' => 'honours'],
        'mikko_best_of_rest' => ['icon' => '🪃', 'title' => 'Best of the Rest', 'desc' => 'Second among members in a GP the season\'s leader won.', 'criteria' => 'Finished second in a Mikkoliiga GP won by the eventual season leader', 'category' => 'honours'],
        'mikko_metronome' => ['icon' => '🥁', 'title' => 'Metronome', 'desc' => 'Three Mikkoliiga GPs in a row in exactly the same position.', 'criteria' => 'Same finishing position among members in three consecutive Mikkoliiga GPs', 'category' => 'honours'],
        'mikko_odile' => ['icon' => '🫀', 'title' => 'Odile Honorary Award', 'desc' => 'Nobody turned up to more Mikkoliiga GPs than you.', 'criteria' => 'Contested the most Mikkoliiga GPs in a season', 'category' => 'honours'],
        'mikko_full_grid' => ['icon' => '🎽', 'title' => 'Full Grid', 'desc' => 'Raced a Mikkoliiga GP every single member turned up for.', 'criteria' => 'Contested a Mikkoliiga GP with the entire membership present', 'category' => 'honours'],
        'mikko_perfect_ten' => ['icon' => '🛞', 'title' => 'Perfect Ten', 'desc' => 'Filled all ten scoring slots of a Mikkoliiga season.', 'criteria' => 'Contested at least ten scoring Mikkoliiga GPs in a season', 'category' => 'honours'],
        'mikko_overflow' => ['icon' => '🪁', 'title' => 'Overflow', 'desc' => 'Raced more Mikkoliiga GPs than the best-ten format can count.', 'criteria' => 'Contested more Mikkoliiga GPs in a season than the best-N cap', 'category' => 'honours'],
        'mikko_nest_egg' => ['icon' => '🪺', 'title' => 'Nest Egg', 'desc' => 'Won a Mikkoliiga GP that was dropped from your best ten.', 'criteria' => 'A Mikkoliiga win that fell outside the best-N scoring slots', 'category' => 'honours'],
        'mikko_reeled_in' => ['icon' => '🎣', 'title' => 'Reeled In', 'desc' => 'Ran down a member who once led you by twenty points.', 'criteria' => 'Finished ahead of a member who led you by 20+ Mikkoliiga points', 'category' => 'honours'],
        'mikko_free_fall' => ['icon' => '🪂', 'title' => 'Free Fall', 'desc' => 'Led the Mikkoliiga, then finished outside the top three.', 'criteria' => 'Led the Mikkoliiga at some point and finished 4th or worse', 'category' => 'honours'],
        'mikko_long_game' => ['icon' => '🕯️', 'title' => 'The Long Game', 'desc' => 'A Mikkoliiga member across three seasons or more.', 'criteria' => 'Recorded in three or more seasons\' Mikkoliiga membership', 'category' => 'honours'],
        'mikko_sunday_driver' => ['icon' => '🚲', 'title' => 'Sunday Driver', 'desc' => 'Showed up late and still made the Mikkoliiga podium.', 'criteria' => 'First contested a Mikkoliiga GP in the season\'s second half and finished top three', 'category' => 'honours'],
        'mikko_promoted' => ['icon' => '🛗', 'title' => 'Promoted', 'desc' => 'Topped the Mikkoliiga and the top half of the main standings.', 'criteria' => 'Led the Mikkoliiga while placing in the top half of the season standings', 'category' => 'honours'],
        ...
        'wooden_spoon' => ['icon' => '🥄', 'title' => 'Wooden Spoon', 'desc' => 'Finished 12th — dead last of the whole field. Someone has to.', 'criteria' => 'Finished 12th (last of the 12-kart field) in a GP', 'category' => 'special'],
